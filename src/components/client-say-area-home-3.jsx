...
const Client_Say_Area_Home_3 = () => {
    return (
        <section className="client-say-area-home-3">
                            ...
                            <div className="swiper-slide">
                                <div className="client-say-inner">
                                    <p>
                                        ...
                                        agement.com has drawn
                                        <br />
                                        rave reviews. It positions us as a
                                        world-class organization
                                        <br />
                                        and adds credibility to our brand. I’ve
                                        seen no.”
                                    </p>
...
export default Client_Say_Area_Home_3
